                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2 px-3 md:px-12 pt-4">
                    <div>
                        ...
                        <div className="py-6 px-5 ">
                            <h2 className="text-2xl font-semibold pb-6">Query on-chain data</h2>
                            ...
                            <Link className="font-semibold text-lg flex pt-2 text-orange-700 " to='https://docs.numia.xyz/overview/sql-access'><span className="border-b-2 hover:border-b-4 border-orange-700 flex">Get SQL Access<span> </span><BsArrowRight className="pt-2 h-6 hover:animate-bounce"></BsArrowRight></span></Link>
                        </div>
                    </div>
                    <div>
                        <div className="card w-full bg-zinc-900 rounded-lg shadow-xl">
                        ...
                        <div className="py-6 px-5 ">
                            <h2 className="text-2xl font-semibold pb-6">Scalable and fast RPCs</h2>
                            ...
                            <Link className="font-semibold text-lg flex pt-2 text-orange-700 " to='https://docs.numia.xyz/overview/rpc-api-access'><span className="border-b-2 hover:border-b-4 border-orange-700 flex">Get RPC Access<span> </span><BsArrowRight className="pt-2 h-6 hover:animate-bounce"></BsArrowRight></span></Link>
                        </div>
                    </div>
                    <div>
                        <div className="card w-full bg-zinc-900 rounded-lg shadow-xl">
                        ...
                        <div className="pt-6 px-5 ">
                            <h2 className="text-2xl font-semibold pb-6">Aggregated API endpoints</h2>
                            ...
                            <Link className="font-semibold text-lg flex pt-2 text-orange-700 " to='https://docs.numia.xyz/overview/advance-api-access'><span className="border-b-2 hover:border-b-4 border-orange-700 flex">Get API Access<span> </span><BsArrowRight className="pt-2 h-6 hover:animate-bounce"></BsArrowRight></span></Link>
                        </div>
                    </div>
                </div>
            </div>
